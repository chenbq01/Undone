...
<body>
	<div data-role="page" data-fullscreen="true">
		...
		<div data-role="content">
			...
			<c:set value="${menu['type_name']}" var="typename" scope="page"></c:set>
			<div data-role="collapsible">
				<h2>${menu['type_name']}</h2>
				<ul data-role="listview" data-split-icon="plus" data-split-theme="d"
					data-inset="false" data-filter="true" data-filter-placeholder=""
					data-filter-theme="c">
					</c:if>
					<li><a href="#"
						onclick="javascript:getDishesCommentData('${menu['id']}');"> <img
							width="80px" height="80px" src="${menu['pic']}"><span
