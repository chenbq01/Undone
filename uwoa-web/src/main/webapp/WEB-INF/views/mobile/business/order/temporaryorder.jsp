		...
		<div data-role="content">
			...
			<form id="listform">
				...
				<c:if test="${temporaryorder['orderdetail'].size() > 0}">
					...
					<c:if test="${buffetlist.size()>0}">
						<p>
							<a id="selbuffet" href="#" onclick="javascript:showBuffetList();"
								data-role="button" data-theme="a" data-mini="true">选择自助餐</a>
						</p>
					</c:if>
						...
						<li class="ui-body ui-body-b">
							<fieldset class="ui-grid-a">
								<div class="ui-block-a">
									<select name="position" id="position" data-mini="true"
										data-inline="true">
								...
								<div class="ui-block-b">
									<input name="waienum" id="waienum" value="" placeholder="等位号"
										type="text" data-mini="true" data-inline="true">
								</div>
							</fieldset>
						</li>
						<li class="ui-body ui-body-b"><input name="numberofpeople"
							id="numberofpeople" value="" placeholder="人数" type="text"
							data-mini="true" data-inline="true"></li>
						<li class="ui-body ui-body-b">
							<fieldset class="ui-grid-a">
								<div class="ui-block-a">
									&nbsp;<select name="isinvoice" id="isinvoice" data-mini="true"
								...
								<div class="ui-block-b">
									<input name="invoicetitle" id="invoicetitle"
										value="${lastorderinfo['invoice_title']}" placeholder="发票抬头"
										type="text" data-mini="true" data-inline="true">
								</div>
							</fieldset>
						</li>
						<li data-role="fieldcontain"><textarea cols="40" rows="8"
								id="remark" name="remark" placeholder="备注" data-inline="true">${lastorderinfo['memo']}</textarea></li>
					...
					<p align="center">
						<a id="_submit" href="#" data-corners="false" data-role="button"
							data-inline="true" data-mini="true" data-theme="a"
							onclick="javascript:_submit();">提交</a>
					</p>
					<div data-role="popup" id="demo" data-theme="a">
						...
						<div id="demo_info" style="overflow: auto;">
							...
							<input name="mobileno1" value="" placeholder="手机号" data-theme="a"
								...
								type="text"> <a href="#" data-role="button"
								data-theme="b" data-icon="check" data-inline="true"
								data-mini="true" data-corners="false"
