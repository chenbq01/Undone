...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/mobile/css/idangerous.swiper.css"/>" />
<link rel="stylesheet" type="text/css"
...
<script
	src="<c:url value="/resources/mobile/js/idangerous.swiper-2.1.min.js"/>"></script>
<script src="<c:url value="/resources/mobile/js/quickbuy.js"/>"></script>
