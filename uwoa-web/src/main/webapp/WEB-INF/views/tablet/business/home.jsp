								...
								<div data-role="popup" id="popupOrgOrderNo"
									...
									<div style="padding: 10px 20px;">
										...
										<input name="add_orderno" value="" placeholder="订单号"
											data-theme="a" type="text"> <a id="a_adddish"
											href="#" data-role="button" data-inline="true" data-theme="b"
								...
								<div data-role="popup" id="popupOrderNo" class="ui-corner-all"
									...
									<div style="padding: 10px 20px;">
										...
										<input name="together_orderno" value="" placeholder="订单号"
											data-theme="a" type="text"> <a id="a_together"
											href="#" data-role="button" data-inline="true" data-theme="b"
											data-icon="check" data-corners="false"
								...
								<div data-role="popup" id="popupOgrOrderNo4DP"
									...
									<div style="padding: 10px 20px;">
										...
										<input name="comment_orderno" value="" placeholder="订单号"
											data-theme="a" type="text"> <a id="a_comment"
											href="#" data-role="button" data-inline="true" data-theme="b"
											data-icon="check" data-corners="false"
				...
				<td width="75%">
					<table>
						<tr valign="top">
							...
							<td nowrap><div class="ui-content">
									<div class="ui-info">
										<strong>餐厅简介：</strong>
									</div>
