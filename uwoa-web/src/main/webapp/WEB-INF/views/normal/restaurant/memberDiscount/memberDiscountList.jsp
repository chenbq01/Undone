	...
	<script>
		...
		function showEdit() {
			...
			jQuery.ajax({
				...
				url : '/uwoa/restaurant/memberDiscount/queryWithSub',
				data : jsonuserinfo,
				dataType : 'json',
					...
					if (data && data.success == "true") {
						...
						$.each(data.data, function(i, item) {
							if(item.is_discount=="1"){
								$('#edit_div input[name=foodtype_id_'+item.id+']').prop("checked",true);
							}
						});
					}
				},
		...
		$("#edit_div").dialog(
				{
					...
					buttons : {
						"保存" : function() {
							...
							var subo=getChecked("foodtype_id_");
							o["sub"]=subo;
							...
							if (bValid) {
								...
								jQuery.ajax({
									type : 'POST',
									contentType : 'application/json',
									url : '/uwoa/restaurant/memberDiscount/edit',
									data : jsonuserinfo,
									dataType : 'json',
									success : function(data) {
