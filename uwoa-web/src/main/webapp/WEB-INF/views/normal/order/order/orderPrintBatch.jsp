...
<%
					order_amount+=Double.parseDouble(row.get("food_amount").toString());
				}
			}
%>
			<tr>
			...
			<tr>
				<td colspan="4">备注：<%=orderMain.get("memo") %></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3">合计：</td>
				<td style="text-align:right"><%=order_amount %></td>
			</tr>
		</table>
		<br>
		<br>
