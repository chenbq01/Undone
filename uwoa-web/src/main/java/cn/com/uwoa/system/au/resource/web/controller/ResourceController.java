package cn.com.uwoa.system.au.resource.web.controller;
 ...
 */
@Controller
public class ResourceController extends FrameController {
	/**
	 * 日志对象
	 */
	...
	protected IFrameService getService() {
		return (IFrameService)resourceService;
	}
	 ...
	 * @return 框架页路径
	 */
	@RequestMapping(value = "/system/au/resource", method = RequestMethod.GET)
	@Override
	public String getPage() {
		return "/system/au/resource/resourceList";
	}
	 ...
	 * @return 查询结果集
	 */
	@RequestMapping(value = "/system/au/resource/query", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return 执行结果
	 */
	@RequestMapping(value = "/system/au/resource/edit", method = RequestMethod.POST)
	@ResponseBody
	 ...
	 * @return 执行结果
	 */
	@RequestMapping(value = "/system/au/resource/delete", method = RequestMethod.POST)
	@ResponseBody
