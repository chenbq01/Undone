package cn.com.uwoa.system.au.role;
...
import cn.com.uwoa.system.au.role.web.controller.RoleController;
...
public class RoleHelper {
	...
	public static String optionHtml(String type){
		//获得数据字典控制器
		RoleController c=SpringContextHolder.getBean("roleController");
		Map<String,Object> condMap = new HashMap<String,Object>();
		condMap.put("page", "-1");
		condMap.put("enable", "1");
		...
		for(int i=0;i<queryData.size();i++){
			...
			returnString.append("<option value=\""+row.get("id")+"\" rowid=\"'+$('#maxRow').val()+'\">"+row.get("name")+"</option>");
		}
