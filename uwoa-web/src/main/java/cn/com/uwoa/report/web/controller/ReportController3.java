 ...
 */
@Controller
public class ReportController3 extends FrameController {
	/**
	 * 日志对象
	 */
	private static final Logger logger = LoggerFactory.getLogger(ReportController3.class);
	 ...
	 * @return 框架页路径
	 */
	@RequestMapping(value = "/report/report3", method = RequestMethod.GET)
	@Override
	public String getPage() {
		return "/report/reportList3";
	}
	 ...
	 * @return 查询结果集
	 */
	@RequestMapping(value = "/report/report3/query", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> query(@RequestBody Map<String,Object> condMap) {
		...
		sql+=" GROUP BY food_name, type_name ORDER BY food_amount DESC";
