	...
	public void testSearch() {
		try {
			String responseBody = Jsoup
					.connect("http://localhost:8080/search/web/search")
			...
			System.out.println(obj.getString("readingmatter"));
			System.out.println(obj.getString("review"));
			System.out.println(obj.getString("comment"));
			System.out.println(obj.getString("topic"));
			System.out.println(obj.getString("user"));
			System.out.println(obj.getString("group"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
