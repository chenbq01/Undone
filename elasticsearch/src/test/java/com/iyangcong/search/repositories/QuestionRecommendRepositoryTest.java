...
public class QuestionRecommendRepositoryTest {
	...
	public void testSearchByKeywords() {
		...
		Page<QuestionRecommend> questionRecommendList = questionRecommendRepository.searchContentByKeywords(keywords, pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = questionRecommendRepository.hitsByKeywords(keywords);
