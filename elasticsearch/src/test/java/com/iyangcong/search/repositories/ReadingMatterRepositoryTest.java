...
public class ReadingMatterRepositoryTest {
	...
	public void testSearchByKeywords() {
		...
		Page<ReadingMatter> readingMatterList = readingMatterRepository.searchContentByKeywords(keywords, pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = readingMatterRepository.hitsByKeywords(keywords);
