...
public class UserServiceTest {
	...
	public void testSearchContentByKeywords() {
		...
		Page<User> userList = userService.searchContentByKeywords(keywords,
				pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = userService.hitsByKeywords(keywords);
	...
	public void testSearchByKeywords() {
		...
		System.out.println(userService.searchByKeywords(keywords, pageable));
