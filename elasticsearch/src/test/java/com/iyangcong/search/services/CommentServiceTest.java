...
public class CommentServiceTest {
	...
	public void testSearchContentByKeywords() {
		...
		Page<Comment> commentList = commentService.searchContentByKeywords(
				keywords, pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = commentService.hitsByKeywords(keywords);
	...
	public void testSearchByKeywords() {
		...
		System.out.println(commentService.searchByKeywords(keywords, pageable));
