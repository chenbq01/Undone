...
public class ReviewServiceTest {
	...
	public void testSearchContentByKeywords() {
		...
		Page<Review> reviewList = reviewService.searchContentByKeywords(
				keywords, pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = reviewService.hitsByKeywords(keywords);
	...
	public void testSearchByKeywords() {
		...
		System.out.println(reviewService.searchByKeywords(keywords, pageable));
