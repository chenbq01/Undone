...
public class SegmentServiceTest {
	...
	public void testSearchContentByKeywords() {
		...
		Page<Segment> segmentList = segmentService.searchContentByKeywords(
				keywords, pageable);
	...
	public void testHitsByKeywords() {
		...
		long hits = segmentService.hitsByKeywords(keywords);
	...
	public void testSearchByKeywords() {
		...
		System.out.println(segmentService.searchByKeywords(keywords, pageable));
