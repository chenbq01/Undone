...
@Document(indexName = "onion", type = "segments", shards = 5, replicas = 1, indexStoreType = "memory", refreshInterval = "-1")
public class Segment {
	...
	public String toString() {
		return "Segment [_id=" + _id + ", _version=" + _version + ", bookid=" + bookid + ", chapterid=" + chapterid + ", language=" + language + ", segment_en=" + segment_en + ", segment_zh=" + segment_zh + "]";
	}
